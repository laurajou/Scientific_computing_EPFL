...
int main(int argc, char *argv[]) {
  ...
  double norm2 =
      std::sqrt(std::pow(v2[0], 2) + std::pow(v2[1], 2) + std::pow(v2[2], 2));

  std::cout << "The Euclidean norm of the first vector is: " << norm1
            << std::endl
            << "The Euclidean norm of the second vector is: " << norm2
            << std::endl;
